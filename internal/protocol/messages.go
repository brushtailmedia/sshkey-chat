...
type DMInfo struct {
	ID      string   `json:"id"`
	Members []string `json:"members"` // always [user_a, user_b]
	// HiddenForCaller controls visibility of this DM in the recipient's
	// sidebar/list view. true means "tombstoned from view" for this user.
	// left_at remains the history cutoff and is independent.
